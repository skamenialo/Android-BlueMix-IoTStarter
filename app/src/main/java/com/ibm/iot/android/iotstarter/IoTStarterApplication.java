...
public class IoTStarterApplication extends Application {
    ...
    private void createNewDefaultProfile() {
        ...
        String deviceType = settings.getString(Constants.DEVICE_TYPE, null);
        String authToken = settings.getString(Constants.AUTH_TOKEN, null);
        IoTProfile newProfile = new IoTProfile("default", organization, deviceId, deviceType, authToken);
        ...
        editor.remove(Constants.DEVICE_TYPE);
